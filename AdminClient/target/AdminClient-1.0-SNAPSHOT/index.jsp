                    ...
                    <form method="post" action="VideoHandleServlet">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control" name="description" style="resize: none" rows="2">
                        ...
                        <input type="submit" name="addvideo" value="Add Video" class="btn btn-success"/>
...
<!--        <section id="updateVideo">
            <div class="main-container container d-flex justify-content-center">
                <div class="container justify-content-center" >
                    ...
                    <form method="post" action="VideoHandleServlet" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Title</label>
                        ...
                        <input type="submit" name="findVideo" value="Find Video" class="btn btn-success"/>
