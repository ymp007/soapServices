 ...
 */
package com.mycompany.soapservices;
...
@NamedQueries({
    ...
    @NamedQuery(name = "Streamingvideos.findByDescription", query = "SELECT s FROM Streamingvideos s WHERE s.description = :description"),
    @NamedQuery(name = "Streamingvideos.findByCategory", query = "SELECT s FROM Streamingvideos s WHERE s.category = :category")})
public class Streamingvideos implements Serializable {
    ...
    public String toString() {
        return "com.mycompany.soapservices.Streamingvideos[ id=" + id + " ]";
    }
